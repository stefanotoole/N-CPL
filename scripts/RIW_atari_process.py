...
def main(cmd_line_args) :
    ...
    'centipede', 'chopper_command', 'crazy_climber', 'defender', 'demon_attack', 'double_dunk', 'enduro', 'fishing_derby', 'freeway', 'frostbite', 'gopher', 'gravitar',
    ...
    'venture', 'video_pinball', 'wizard_of_wor', 'yars_revenge', 'zaxxon']#'Breakout', 'Freeway', 'Pong', 'Qbert', 'Skiing', 'Asteroids', 'Tennis', 'SpaceInvaders']
    trialNums = [0, 1, 2, 3, 4]
    num_workers = 80
    DIR = '../forParallelRuns'
